...
ASSETS: dict[str, dict] = {
    ...
    "sse_composite": {
        "name": "上证指数",
        "category": "equity",
        "path": "data/processed/indices/sse_composite_monthly_1990_2026.csv",
        "value_column": "index_level",
        "unit": "index points",
        "frequency": "monthly",
        "notes": "月度月末指数点位（东方财富 kline，不复权）；上交所 1990-12 开业起。",
    },
    "csi300": {
        "name": "沪深 300",
        "category": "equity",
        "path": "data/processed/indices/csi300_monthly_2005_2026.csv",
        "value_column": "index_level",
        "unit": "index points",
        "frequency": "monthly",
        "notes": "月度月末指数点位（东方财富 kline，不复权）；2005-01 起。",
    },
    ...
    "china_treasury_bond_index": {
        "name": "中国国债指数",
        "category": "bond",
        "path": "data/processed/bonds/china_treasury_bond_index_monthly_2003_2026.csv",
        "value_column": "index_level",
        "unit": "index points",
        "frequency": "monthly",
        "notes": "月度月末国债指数点位（东方财富 kline，含票息再投资的总回报类指数）；2003-02 起。",
    },
    CASH_ID: {
        "name": "现金",
        "category": "cash",
